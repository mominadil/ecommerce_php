...
if (mysqli_num_rows($selectresult1)>0) {
    echo "<script>alert('Product is already exsist in cart');
    ...
    $sql = "INSERT INTO cart_db(product_id,quantity,session_id	)VALUES('$product_id','$quantity', '$user_id')";
    $result=mysqli_query($conn,$sql);
    echo "<script>alert('Product is added in cart');
    window.location.href = 'cart_page.php';
    </script>";
